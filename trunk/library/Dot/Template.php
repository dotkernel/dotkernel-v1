 ...
 *
 * @category   DotKernel
 * @copyright  Copyright (c) 2016-2018 Apidemia Inc. (https://www.apidemia.com)
...
class Dot_Template
{
    ...
    private function _filename($filename)
    {
        ...
        if (is_array($this->_fileFallbacks) && count($this->_fileFallbacks) > 0)
        {
            ...
            // PHP 7.2 removal of each()
            foreach($this->_fileFallbacks as $x => $v)
            {
