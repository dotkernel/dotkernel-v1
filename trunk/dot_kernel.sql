...
(9, 'smtpAddresses', 'aol.com;aim.com;comcast.net;hotmail.com;earthlink.net;juno.com;juno.net;bellsouth.net;cox.net;roadrunner.com;sbcglobal.net;rospace.com', 'Email servers where we need to use external SMTP in order to send emails.', '', '0', 'textarea', ''),
(10, 'smtpActive', '1', 'Use external SMTP servers', 'If we use or not external SMTP servers.', '1', 'radio', '1;0'),
(11, 'resultsPerPage', '2', 'Default results per page', 'How many records will be on every page, if is not specified otherwise by a specific configuration value', '1', 'option', '5;10;20;30;40;50');
