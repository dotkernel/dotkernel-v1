...
('contact_recipient', 'Contact us email.', 'The email address that recieves all contact emails from the site.', 'marius@dotboost.com', 'Y', 'textarea', ''),
('admin_link_name_to_site', '', '', 'dotKernel', 'N', 'textarea', ''),
('admin_link_to_site', '', '', 'http://localhost/dotKernel/', 'N', 'textarea', ''),
('admin_email', 'Admin Email.', 'The "From" field of an email sent by the script.', 'julian@dotboost.com', 'Y', 'textarea', ''),
('site_name', '', 'Used in admin panel.', 'dotKernel', 'N', 'textarea', ''),
('company_link', '', '', 'http://localhost/dotKernel/', 'N', 'textarea', ''),
('license_url', '', '', 'http://www.dotboost.com/', 'N', 'textarea', ''),
