					...
					<table cellpadding="0" cellspacing="0" class="medium_table" width="100%">
						...
						<tr>
							...
							<tr>
								...
								<td class="row1">
								<label for="active1">Yes</label> <input type="radio" id="active1" name="isActive" value="1" {ACTIVE_YES}>
								<label for="active0">No</label>	<input type="radio" id="active0" name="isActive" value="0" {ACTIVE_NO}>
								</td>
							</tr>
						<tr>
							<td class="row2"></td>
