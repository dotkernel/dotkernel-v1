...
<head>
	...
	<link rel="stylesheet" href ="{SITE_URL}/externals/jquery/jquery-ui-1.8.12.css" type="text/css" >
	...
	<script type="text/javascript" src="{SITE_URL}/externals/jquery/jquery-ui-1.8.12.min.js"></script>
